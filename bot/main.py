...
async def main() -> None:
    ...
    dp.include_router(weather.router)    # /weather (before skills — skills catch-all eats /-commands)
    dp.include_router(news.router)       # /news, /news_add, /news_sources, /news_remove (before skills)
